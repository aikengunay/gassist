...
function showHelp() {
  console.log(`
${chalk.bold('git-assist')} - Interactive git workflow and branch management

${chalk.bold('Usage:')}
  git-assist                Interactive git workflow management
  git-assist --version      Show version
  git-assist --help         Show this help message
